...
export type SetRepositoryStatsMutationVariables = Exact<{
  ...
  range?: InputMaybe<Schedule>;
  mesh: Scalars['Mesh']['input'];
  pullRequests: Array<PullRequestEntry> | PullRequestEntry;
